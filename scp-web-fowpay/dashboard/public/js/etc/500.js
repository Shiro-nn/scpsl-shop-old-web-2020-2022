(() => {
  ...
  const errMsgs = [
    ...
    { type: "cmd", content: [":(){ :|: & };:"] },
    {
      type: "err",
      content: [
        `[${Math.round(Math.random() * 89999 + 10000)}.${Math.round(
          Math.random() * 899999 + 100000
        )}] Out of memory: Kill process ${Math.round(
          Math.random() * 89999 + 10000
        )} (user) score ${Math.round(Math.random() * 8 + 1)} or sacrifice child`
      ]
    }
  ];
    ...
    errMsgs.push({
      ...
      content: [
        `[${Math.round(Math.random() * 89999 + 10000)}.${Math.round(
          ...
          "00000000" + (Math.round(Math.random() * 256) >>> 0).toString(2)
        ).substr(-8)} ${(
          "00000000" + (Math.round(Math.random() * 256) >>> 0).toString(2)
        ).substr(-8)} ${(
          "00000000" + (Math.round(Math.random() * 256) >>> 0).toString(2)
