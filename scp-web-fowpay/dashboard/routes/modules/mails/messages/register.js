...
module.exports = function(login, verify){
...
<div style="height: 15px; line-height: 15px; font-size: 0px;">&nbsp;</div>
<div align="left">
<b style="font-family: Arial; color: #000000; font-size: 25px; line-height: 35px;">Регистрация завершена</b>
<div style="height: 30px; line-height: 30px; font-size: 0px;">&nbsp;</div>
<span style="font-family: Arial; color: #000000; font-size: 20px; line-height: 27px;">Подтвердите свою почту, перейдя по <a href="${verify}" target="_blank" style="color:red;">ссылке</a></span>
...
<div style="height: 17px; line-height: 17px; font-size: 17px;">&nbsp;</div>
<span style="font-family: Arial; color: #000000; font-size: 20px; line-height: 27px;">Логин: <b>${login}</b></span>
</div>
<div style="height: 15px; line-height: 15px; font-size: 0px;">&nbsp;</div>
</td>
</tr>
