...
module.exports = function(config = {
    ...
    httpOnly: true,
    domain: 'eu.scpsl.shop',
    path: '/',
    secure: true
}) {
    const guid = () => {
        return DoGUID() + DoGUID();
        function DoGUID(){return 'xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxx'.replace(/[xy]/g, function(c) {var r = Math.random()*16|0,v=c=='x'?r:r&0x3|0x8;return v.toString(16);});}
    }
    let cache = [];
    return {
        config:config,
